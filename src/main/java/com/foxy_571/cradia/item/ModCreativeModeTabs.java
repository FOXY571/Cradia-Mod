...
public class ModCreativeModeTabs {
    ...
    public static final Supplier<CreativeModeTab> CRADIA_TAB = registerCreativeModeTab("cradia_tab", new ItemStack(ModItems.CRADIUM_INGOT.get()), "creativetab.cradia.cradia_tab", (itemDisplayParameters, output) -> {
    ...
    public static Supplier<CreativeModeTab> registerCreativeModeTab(String name, ItemStack icon, String key, CreativeModeTab.DisplayItemsGenerator displayItemsGenerator) {
        return CREATIVE_MODE_TABS.register(name, () -> CreativeModeTab.builder().icon(() -> icon).title(Component.translatable(key)).displayItems(displayItemsGenerator).build());
    }
