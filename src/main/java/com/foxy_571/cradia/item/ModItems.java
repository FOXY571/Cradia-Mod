...
public class ModItems {
    ...
    public static final DeferredItem<Item> NAUADIAN_SHARD;
    public static final DeferredItem<Item> NAUADIAN_INGOT;
    public static final DeferredItem<Item> RAW_ADRENA;
    public static final DeferredItem<Item> ADRENA_INGOT;
    public static final DeferredItem<Item> CRADIUM_SCRAP;
    public static final DeferredItem<Item> CRADIUM_INGOT;
    public static final DeferredItem<Item> NAUADIAN_ARROW;
    public static final DeferredItem<Item> ADRENA_ARROW;
    public static final DeferredItem<Item> CRADIUM_ARROW;
    public static final DeferredItem<Item> NAUADIAN_LONG_SWORD;
    public static final DeferredItem<Item> NAUADIAN_SCYTHE;
    public static final DeferredItem<Item> NAUADIAN_BATTLE_AXE;
    public static final DeferredItem<Item> NAUADIAN_DAGGER;
    public static final DeferredItem<Item> ADRENA_LONG_SWORD;
    public static final DeferredItem<Item> ADRENA_SCYTHE;
    public static final DeferredItem<Item> ADRENA_BATTLE_AXE;
    public static final DeferredItem<Item> ADRENA_DAGGER;
    public static final DeferredItem<Item> CRADIUM_LONG_SWORD;
    public static final DeferredItem<Item> CRADIUM_SCYTHE;
    public static final DeferredItem<Item> CRADIUM_BATTLE_AXE;
    public static final DeferredItem<Item> CRADIUM_DAGGER;
    public static final DeferredItem<Item> REINFORCED_STICK;
    public static final DeferredItem<Item> NAUADIAN_NUGGET;
    public static final DeferredItem<Item> ADRENA_NUGGET;
    public static final DeferredItem<Item> CRADIUM_NUGGET;
    public static final DeferredItem<Item> NAUADIAN_ZOMBIE_SPAWN_EGG;
    public static final DeferredItem<Item> NAUADIAN_SKELETON_SPAWN_EGG;
    ...
    static {
        ...
        NAUADIAN_BATTLE_AXE = ITEMS.register("nauadian_battle_axe", () -> new BattleAxeItem(ModTiers.NAUADIAN, (new Item.Properties()).attributes(BattleAxeItem.createAttributes(ModTiers.NAUADIAN, 6, -3.25F))));
        ...
        ADRENA_BATTLE_AXE = ITEMS.register("adrena_battle_axe", () -> new BattleAxeItem(ModTiers.ADRENA, (new Item.Properties()).attributes(BattleAxeItem.createAttributes(ModTiers.ADRENA, 6, -3.25F))));
        ...
        CRADIUM_BATTLE_AXE = ITEMS.register("cradium_battle_axe", () -> new BattleAxeItem(ModTiers.CRADIUM, (new Item.Properties()).attributes(BattleAxeItem.createAttributes(ModTiers.CRADIUM, 6, -3.25F))));
