...
public class ModEntityTypes {
    ...
    static {
        ...
        NAUADIAN_ZOMBIE = registerEntityType("nauadian_zombie", EntityType.Builder.of(NauadianZombie::new, MobCategory.MONSTER).sized(0.6F, 1.95F).eyeHeight(1.74F).passengerAttachments(2.0125F).ridingOffset(-0.7F).clientTrackingRange(8));
        TIERED_ARROW = registerEntityType("tiered_arrow", EntityType.Builder.<TieredArrow>of(TieredArrow::new, MobCategory.MISC).sized(0.5F, 0.5F).eyeHeight(0.13F).clientTrackingRange(4).updateInterval(20));
